...
python $RMATS_DIR/rmats.py --b1 $HOME/GrASE_simulation/rMATS/rmats_prep/${CELLTYPE}.prep.txt --gtf $GTF_FILE -t single --readLength 100 --nthread 16 --od $HOME/GrASE_simulation/rMATS/rmats_prep/${CELLTYPE} --tmp $HOME/GrASE_simulation/rMATS/rmats_prep/tmp_${CELLTYPE} --task prep
